...
# ==================== first section =================================
# take a look at some lines of our datafile to see the original format
...
#printLines(os.path.join(corpus, "datafile.txt"))
#printLines(os.path.join(corpus, "utterances.jsonl"))

# ======================================================================================================

# =========================== 2nd section==========================
# "loadLinesAndConversations()" :-  splits each line of the file into a dictionary of lines with
#  fields: lineID, characterID, and text and then groups them into conversations with fields: conversationID, movieID, and lines.
...
# ===================================== 3rd section ========================================================================
# call functions of the 2nd section


# Define path to new file
datafile = os.path.join(corpus, "datafile.txt")
...
indexes, a reverse mapping of indexes to words, a count of each word and a total word count.
...
def filterPair(p):
    ...
    #print("-P[0]", len(p[0].split(' ')), ">>>", p[0].split(' '))
    #print("-P[1]", len(p[1].split(' ')), ">>>", p[1].split(' '))
...
def indexesFromSentence(voc, sentence):
    # print("====me====index from sentence ========================",
    #  (voc.word2index[word] for word in sentence.split(' ')))
